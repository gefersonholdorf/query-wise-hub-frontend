...
import { CircleAlert, CircleCheck, CircleX, Clock, LoaderCircle, Plus, Save, Trash2 } from "lucide-react";
...
import { useUpdateAnalysisById } from "../http/use-update-analysis-by-id";
...
interface DetailComponentProps {
    ...
    onIsSaved: boolean
    onSetIsSaved: (state: boolean) => void
}

export function DetailComponent({ analysis, onIsSaved, onSetIsSaved }: DetailComponentProps) {
    const { mutateAsync, isPending } = useUpdateAnalysisById(analysis.id)
    ...
    return (
        <form onSubmit={updateForm.handleSubmit(handleOnSubmitUpdate)}>
